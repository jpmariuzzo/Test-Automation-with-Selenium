...
listSum = 0
for price in prices:
    listSum += int(price.text)

print ("Check of Total Amount: ", listSum)
assert listSum == int(driver.find_element(By.CSS_SELECTOR, ".totAmt").text)
assert float(driver.find_element(By.CSS_SELECTOR, ".discountAmt").text) < float(driver.find_element(By.CSS_SELECTOR, ".totAmt").text)
discount = 100-100*(float(driver.find_element(By.CSS_SELECTOR, ".discountAmt").text)/float(driver.find_element(By.CSS_SELECTOR, ".totAmt").text))

print("Discount of",int(discount), "%!")
time.sleep(3)